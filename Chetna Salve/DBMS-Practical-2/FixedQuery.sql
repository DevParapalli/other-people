...
VALUES ('Akash ', 'Microsoft', 18000, '11-01-23'),
    ('Pooja', 'Google ', 16000, '18-03-23'),
    ('Priya', 'Accenture', 18000, '19-04-23'),
    ('Sakshi', 'Persistent', 17000, '12-03-23'),
    ('Siya', 'Hexaware', 19000, '14-01-23'),
    ('Aarav', 'Zoho', 15000, '13-05-23');

INSERT INTO Company
VALUES ('Microsoft', 'san Fron '),
    ('Google', 'California'),
    ('Accenture', 'Mumbai'),
    ('zoho', 'Pune'),
    ('Hexaware', 'Nagpur'),
